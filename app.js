...
const FALLBACK_LIST = {
  main: [
    { id:1,  title:'Beef Wellington',   description:'Beef tenderloin wrapped in puff pastry with mushroom duxelles',      img:'images/beef-wellington.jpg' },
    { id:2,  title:'Lobster Thermidor', description:'Lobster in a rich creamy sauce with a golden cheese crust',          img:'images/lobster-thermidor.jpg' },
    { id:3,  title:'Duck Confit',       description:'Slow-cooked duck leg in its own fat with garlic and herbs',          img:'images/duck-confit.jpg' },
    { id:10, title:'Coq au Vin',        description:'Chicken braised in red wine with pearl onions and mushrooms',        img:'images/coq-au-vin.jpg' },
    { id:11, title:'Rack of Lamb',      description:'Herb-crusted rack of lamb with roasted vegetables and jus',          img:'images/rack-of-lamb.jpg' },
  ],
  drink: [
    { id:4,  title:'Classic Martini',    description:'Premium gin or vodka with dry vermouth, garnished elegantly',        img:'images/classic-martini.jpg' },
    { id:5,  title:'Château Margaux',    description:'Exceptional Bordeaux with notes of blackcurrant and cedar',         img:'images/chateau-margaux.jpg' },
    { id:6,  title:'Champagne Cocktail', description:'Champagne with sugar cube and Angostura bitters',                   img:'images/champagne-cocktail.jpg' },
    { id:12, title:'Old Fashioned',      description:'Classic whiskey cocktail with sugar, bitters, and orange peel',     img:'images/old-fashioned.jpg' },
    { id:13, title:'French 75',          description:'Gin, lemon juice, and champagne — bright and celebratory',          img:'images/french-75.jpg' },
  ],
  dessert: [
    { id:7,  title:'Crème Brûlée',      description:'Vanilla custard beneath a perfectly caramelized sugar crust',       img:'images/creme-brulee.jpg' },
    { id:8,  title:'Chocolate Soufflé', description:'Light airy chocolate dessert served with vanilla ice cream',        img:'images/chocolate-souffle.jpg' },
    { id:9,  title:'Tarte Tatin',       description:'Upside-down apple tart with caramelized apples and pastry',         img:'images/tarte-tatin.jpg' },
    { id:14, title:'Tiramisu',          description:'Coffee-soaked ladyfingers with mascarpone cream',                   img:'images/tiramisu.jpg' },
    { id:15, title:'Lemon Posset',      description:'Silky cream dessert with bright fresh lemon',                       img:'images/lemon-posset.jpg' },
  ],
};

const FALLBACK_DETAIL = {
  1:  { title:'Beef Wellington',   description:'A showpiece of classical cuisine.',
        img:'images/beef-wellington.jpg',
  ...
  4:  { title:'Classic Martini',   description:'The benchmark of cocktail elegance.',
        img:'images/classic-martini.jpg',
  ...
  5:  { title:'Château Margaux',   description:'Bordeaux at its most refined.',
        img:'images/chateau-margaux.jpg',
  ...
  6:  { title:'Champagne Cocktail',description:'Timeless celebratory elegance.',
        img:'images/champagne-cocktail.jpg',
  ...
  8:  { title:'Chocolate Soufflé', description:'Drama and delight in equal measure.',
        img:'images/chocolate-souffle.jpg',
