...
function loadDetail(id) {
  ...
  fetch(API + 'get-recipes/?id=' + id)
    .then(r => { if (!r.ok) throw 0; return r.json(); })
    .then(data => { if (data && data.length) renderDetail(data[0]); else throw 0; })
...
const FALLBACK_LIST = {
  main: [
    { id:1,  title:'Beef Wellington',   description:'Beef tenderloin wrapped in puff pastry with mushroom duxelles' },
    { id:2,  title:'Lobster Thermidor', description:'Lobster in a rich creamy sauce with a golden cheese crust' },
    { id:3,  title:'Duck Confit',       description:'Slow-cooked duck leg in its own fat with garlic and herbs' },
    { id:10, title:'Coq au Vin',        description:'Chicken braised in red wine with pearl onions and mushrooms' },
    { id:11, title:'Rack of Lamb',      description:'Herb-crusted rack of lamb with roasted vegetables and jus' },
  ],
  drink: [
    { id:4,  title:'Classic Martini',    description:'Premium gin or vodka with dry vermouth, garnished elegantly' },
    { id:5,  title:'Château Margaux',    description:'Exceptional Bordeaux with notes of blackcurrant and cedar' },
    { id:6,  title:'Champagne Cocktail', description:'Champagne with sugar cube and Angostura bitters' },
    { id:12, title:'Old Fashioned',      description:'Classic whiskey cocktail with sugar, bitters, and orange peel' },
    { id:13, title:'French 75',          description:'Gin, lemon juice, and champagne — bright and celebratory' },
  ],
  dessert: [
    { id:7,  title:'Crème Brûlée',      description:'Vanilla custard beneath a perfectly caramelized sugar crust' },
    { id:8,  title:'Chocolate Soufflé', description:'Light airy chocolate dessert served with vanilla ice cream' },
    { id:9,  title:'Tarte Tatin',       description:'Upside-down apple tart with caramelized apples and pastry' },
    { id:14, title:'Tiramisu',          description:'Coffee-soaked ladyfingers with mascarpone cream' },
    { id:15, title:'Lemon Posset',      description:'Silky cream dessert with bright fresh lemon' },
  ],
};
...
const FALLBACK_DETAIL = {
  ...
  14: { title:'Tiramisu',          description:"Italy's most beloved dessert.",
        ...
        method:'<li>Whisk yolks and sugar until thick and pale</li><li>Beat in mascarpone until smooth</li><li>Fold in stiffly whipped egg whites</li><li>Mix espresso and liqueur in a shallow bowl</li><li>Briefly dip biscuits and layer in dish</li><li>Spread half the cream, add another biscuit layer, top with cream</li><li>Chill 4–6 hours and dust with cocoa to serve</li>' },
